...
class TextToSpeechPage extends StatefulWidget {
  ...
  @override
  State<TextToSpeechPage> createState() => TextToSpeechPageState();
}

class TextToSpeechPageState extends State<TextToSpeechPage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            AvatarGlow(
              animate: isSpeaking,
              glowColor: const Color.fromARGB(255, 177, 33, 243),
              glowBorderRadius: BorderRadius.circular(70),
